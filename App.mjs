...
export default function App() {
    return React.createElement(AppContextProvider, {},
        React.createElement('div', {id: 'head'}, React.createElement('h1', null, 'Chat Display')),
        React.createElement('div', {id: 'file-select'}, React.createElement(FileSelector)),
        React.createElement('div', {id: 'participants-radio'}, React.createElement(ParticipantSelector)),
